...
/**
 * EN: NomadTab spawner for the PGX Version Control Inspector Panel.
 *     Registers/unregisters the tab with FGlobalTabmanager.
 *     Accessible from: PGX Toolbar > Tools > Version Control Inspector
 * ES: Spawner de NomadTab para el Panel Inspector de PGX Version Control.
 *     Registra/desregistra el tab con FGlobalTabmanager.
 *     Accesible desde: PGX Toolbar > Tools > Version Control Inspector
 */
class PGXVERSIONCONTROLEDITOR_API FPGXVersionControlInspectorTabSpawner
{
public:
