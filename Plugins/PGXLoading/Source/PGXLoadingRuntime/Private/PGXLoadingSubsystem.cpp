...
void UPGXLoadingSubsystem::RegisterConsoleCommands()
{
	RegisteredCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.loading.status"),
		TEXT("Show current loading screen state, context, timing, and conditions"),
	...
	RegisteredCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.loading.request"),
		TEXT("Manual RequestLoading with context tag (e.g., pgx.loading.request PGX.Loading.Context.Default)"),
	...
	RegisteredCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.loading.close"),
		TEXT("Force close loading screen"),
		FConsoleCommandDelegate::CreateWeakLambda(this, [this]()
		{
	...
	RegisteredCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.loading.skip"),
		TEXT("Request skip (validates conditions)"),
		FConsoleCommandDelegate::CreateWeakLambda(this, [this]()
		{
	...
	RegisteredCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.loading.profiles"),
		TEXT("List all discovered profiles and context mappings"),
		FConsoleCommandDelegate::CreateWeakLambda(this, [this]()
		{
	...
	RegisteredCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.loading.config"),
		TEXT("Show active config values"),
		FConsoleCommandDelegate::CreateWeakLambda(this, [this]()
		{
	...
	RegisteredCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.loading.history"),
		TEXT("Show loading history with metrics"),
		FConsoleCommandDelegate::CreateWeakLambda(this, [this]()
		{
	...
	RegisteredCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.loading.debug"),
		TEXT("Show detailed debug info (fade state, close conditions, active strategy)"),
		FConsoleCommandDelegate::CreateWeakLambda(this, [this]()
		{
	...
	RegisteredCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.loading.simulate"),
		TEXT("Simulate loading with artificial delay (e.g., pgx.loading.simulate 3.0)"),
		FConsoleCommandWithArgsDelegate::CreateWeakLambda(this, [this](const TArray<FString>& Args)
		{
	...
	RegisteredCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.loading.simulate.pso"),
		TEXT("Simulate PSO delay — blocks close until timeout (e.g., pgx.loading.simulate.pso 5.0)"),
		FConsoleCommandWithArgsDelegate::CreateWeakLambda(this, [this](const TArray<FString>& Args)
		{
			if (CurrentState == EPGXLoadingScreenState::Idle)
			{
...
void UPGXLoadingSubsystem::UnregisterConsoleCommands()
{
