...
public:
	 ...
	 *     the first asset tag (project content authors this on the `UGameplayAbility` Blueprint/class,
	 ...
	 * ES: Conceder una ability por clase. El tag de identidad se lee del primer asset tag del CDO
	 *     de la clase.
	 */
