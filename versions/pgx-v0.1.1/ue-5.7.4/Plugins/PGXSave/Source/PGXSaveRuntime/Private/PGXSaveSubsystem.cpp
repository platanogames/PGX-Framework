...
void UPGXSaveSubsystem::ExecuteConsoleCommand(const FString& CommandName, const TArray<FString>& Args, UWorld* World)
{
	if (CommandName == TEXT("pgx.save.autosave"))
	{
		if (Args.Num() == 0)
		{
	...
	if (CommandName == TEXT("pgx.save.delete"))
	{
		if (Args.Num() < 2)
		{
	...
	if (CommandName == TEXT("pgx.save.info"))
	{
		if (Args.Num() < 2)
		{
	...
	if (CommandName == TEXT("pgx.save.list"))
	{
	...
	if (CommandName == TEXT("pgx.save.load"))
	{
		if (Args.Num() < 2)
		{
	...
	if (CommandName == TEXT("pgx.save.quickload"))
	{
		if (Args.Num() == 0)
		{
	...
	if (CommandName == TEXT("pgx.save.quicksave"))
	{
		if (Args.Num() == 0)
		{
	...
	if (CommandName == TEXT("pgx.save.save"))
	{
		if (Args.Num() < 2)
		{
	...
	if (CommandName == TEXT("pgx.save.slots"))
	{
		if (Args.Num() == 0)
		{
	...
	if (CommandName == TEXT("pgx.save.stats"))
	{
