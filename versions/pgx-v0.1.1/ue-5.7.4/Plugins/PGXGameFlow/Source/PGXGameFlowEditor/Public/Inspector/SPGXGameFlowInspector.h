...
/**
 * EN: read-only GameFlow Inspector. Inherits canonical layout from
 *     the shared editor-inspector base.
 * ES: Inspector GameFlow read-only — hereda layout canonical.
 */
class SPGXGameFlowInspector : public SPGXPass1InspectorBase
{
public:
	SLATE_BEGIN_ARGS(SPGXGameFlowInspector) {}
	SLATE_END_ARGS()
