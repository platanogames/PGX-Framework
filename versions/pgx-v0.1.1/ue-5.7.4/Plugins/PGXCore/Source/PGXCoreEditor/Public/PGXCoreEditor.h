...
private:
	/** EN: Register type actions after provider modules are live / ES: Registrar type actions tras cargar modulos proveedores */
	void RegisterAssetTypeActions();

	/** EN: Post-engine callback used during cold startup / ES: Callback post-engine usado durante arranque en frio */
	void HandlePostEngineInit();

	/** EN: Registered asset type actions for cleanup / ES: Acciones de tipo de asset registradas para limpieza */
	TArray<TSharedPtr<IAssetTypeActions>> RegisteredAssetTypeActions;

	/** EN: Deferred startup delegate / ES: Delegate de arranque diferido */
