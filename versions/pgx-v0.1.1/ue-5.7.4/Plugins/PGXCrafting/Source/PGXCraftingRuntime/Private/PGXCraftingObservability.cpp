...
FString PGXCraftingObservability::EscapeJsonString(const FString& Value)
{
...
FName PGXCraftingObservability::GetOwningPluginName(const UObject* Object, FName FallbackPluginName)
{
...
FPGXValidationResult PGXCraftingObservability::ValidateJsonEnvelope(const FPGXJsonValue& Json, const FText& EmptyPayloadMessage)
{
	if (Json.IsEmpty())
	{
...
FPGXSchemaDescriptor PGXCraftingObservability::MakeSchemaDescriptor(const UObject* Object, FName SchemaVersion, FName FallbackPluginName)
{
