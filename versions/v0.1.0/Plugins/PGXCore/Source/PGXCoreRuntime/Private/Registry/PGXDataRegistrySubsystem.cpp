...
void UPGXDataRegistrySubsystem::RegisterConsoleCommands()
{
	ConsoleCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.registry.list"),
		TEXT("EN: List all databases / ES: Listar todas las bases de datos"),
	...
	ConsoleCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.registry.stats"),
		TEXT("EN: Show stats for a database / ES: Mostrar stats de una base de datos"),
	...
	ConsoleCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.registry.export"),
		TEXT("EN: Export a database as JSON / ES: Exportar una base de datos como JSON"),
		FConsoleCommandWithArgsDelegate::CreateWeakLambda(this, [this](const TArray<FString>& Args)
		{
			if (Args.Num() < 1)
			{
	...
	ConsoleCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.registry.export.all"),
		TEXT("EN: Export all databases as JSON / ES: Exportar todas las bases de datos como JSON"),
		FConsoleCommandDelegate::CreateWeakLambda(this, [this]()
		{
	...
	// ─── v2.0 Console Commands ───

	ConsoleCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.registry.ingest"),
		TEXT("EN: Force re-ingest all definitions / ES: Forzar re-ingesta de todas las definiciones"),
		FConsoleCommandDelegate::CreateWeakLambda(this, [this]()
		{
			EntryIndex.Empty();
			CompositeReverseIndex.Empty();
	...
	ConsoleCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.registry.validate"),
		TEXT("EN: Run validation on databases / ES: Ejecutar validacion en bases de datos"),
		FConsoleCommandWithArgsDelegate::CreateWeakLambda(this, [this](const TArray<FString>& Args)
		{
	...
	ConsoleCommands.Add(IConsoleManager::Get().RegisterConsoleCommand(
		TEXT("pgx.registry.definitions"),
		TEXT("EN: List active registry definitions / ES: Listar definiciones activas de registro"),
		FConsoleCommandDelegate::CreateWeakLambda(this, [this]()
		{
...
void UPGXDataRegistrySubsystem::UnregisterConsoleCommands()
{
