...
PGX is a Development Preview. These limits apply to the `v0.1.0` public release.
...
- The exported snapshot is validated for Editor and Game Windows Development
  targets. Packaged and Shipping targets, other platforms and other engine
