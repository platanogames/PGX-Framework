...
FString PGXInventoryObservability::EscapeJsonString(const FString& Value)
{
...
FName PGXInventoryObservability::GetOwningPluginName(const UObject* Object, FName FallbackPluginName)
{
...
FPGXValidationResult PGXInventoryObservability::ValidateJsonEnvelope(const FPGXJsonValue& Json, const FText& EmptyPayloadMessage)
{
	if (Json.IsEmpty())
	{
...
FPGXSchemaDescriptor PGXInventoryObservability::MakeSchemaDescriptor(const UObject* Object, FName SchemaVersion, FName FallbackPluginName)
{
