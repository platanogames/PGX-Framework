...
public:
	...
	bool SignalCompletionForTesting() { return AcceptCompletionSignal(); }
	void SetStateForTesting(EPGXLoadingScreenState State) { CurrentState = State; bPostLoadMapReceived = false; PostLoadFrameCount = 7; }
	bool WasCompletionReceivedForTesting() const { return bPostLoadMapReceived; }
	int32 GetPostLoadFrameCountForTesting() const { return PostLoadFrameCount; }
	void RediscoverProfilesForTesting() { DiscoverProfiles(); }
	bool DidProfileTableFallbackForTesting() const { return bProfileTableFallbackUsedForTesting; }
#endif
...
#if WITH_DEV_AUTOMATION_TESTS
	bool bProfileTableFallbackUsedForTesting = false;
#endif
...
private:
	friend class FPGXLoadingRuntimeModule;
